...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasWithBackdrop" aria-labelledby="offcanvasWithBackdropLabel">
  ...
  <div class="offcanvas-body">
	<?php if (($_GET['panel']) == "1"): ?>
	  ...
	  <div class="col-12 gy-4">
		<a class="btn btn-light g-4 w-100 py-1 px-2 shadow-sm option-system option-system-menu rounded-0 color-gray" role="button" href="panel-administrador.php?panel=2">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="admin-mesas.php">Mesas</a></li>
