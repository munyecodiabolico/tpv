...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasWithBackdrop" aria-labelledby="offcanvasWithBackdropLabel">
  ...
  <div class="offcanvas-body">
    <div class="col-12 gy-4">
          <a class="btn btn-primary w-100 py-1 px-2 shadow-sm option-system option-system-menu rounded-0" role="button" href="mesas.php">
              <h2><i class="fa fa-th" aria-hidden="true"></i> Mesas</h2>
          </a>
      </div>
      <div class="col-12 gy-4">
          <a class="btn btn-secondary g-4 w-100 py-1 px-2 shadow-sm option-system option-system-menu rounded-0" role="button" href="">
              
              <h2><i class="fa fa-truck" aria-hidden="true"></i> Proveedores</h2>
          </a>
      </div>
      <div class="col-12 gy-4">
          <a class="btn btn-success g-4 w-100 py-1 px-2 shadow-sm option-system option-system-menu rounded-0" role="button" href="">
              
              <h2><i class="fa fa-file-text-o" aria-hidden="true"></i> Facturación</h2>
          </a>
      </div>
      <div class="col-12 gy-4">
          <a class="btn btn-warning g-4 w-100 py-1 px-2 shadow-sm option-system option-system-menu rounded-0" role="button" href="">
          
              <h2><i class="fa fa-line-chart" aria-hidden="true"></i> Estadísticas</h2>
          </a>
      </div>
      <div class="col-12 gy-4">
      ...
      <div class="col-12 gy-4">
          <a class="btn btn-dark g-4 w-100 py-1 px-2 shadow-sm option-system option-system-menu rounded-0" role="button" href="">
              ...
              <h2><i class="fa fa-cart-arrow-down" aria-hidden="true"></i> Stock</h2>
          </a>
      </div>
    </div>
  </div>
